 ...
 * @author Sergio
 */
public class BusquedaCli extends javax.swing.JDialog {

    /**
     * Creates new form BusquedaCli
     */
    public BusquedaCli(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
 ...
 public void buscar(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BusquedaCli.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BusquedaCli dialog = new BusquedaCli(new javax.swing.JFrame(), true);
